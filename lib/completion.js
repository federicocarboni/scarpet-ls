...
export function onCompletionResolve(item) {
    if (
        item.data !== undefined &&
        item.data !== null &&
 ...
 * @param {import('@federicocarboni/scarpet-parser').FunctionDeclaration[]} declarations
 * @param {Range} range
 ...
 * @param {boolean} useMarkdown
 * @param {CompletionItem[]} items
 * @param {import('@federicocarboni/scarpet-parser/types/findDefinition.js').VariableDefinition[]} variables
 * @param {Range} range
 * @returns
 */
...
/**
 * @param {import('vscode-languageserver').ClientCapabilities} clientCapabilities
 * @param {import('@federicocarboni/scarpet-parser').Node} root
 * @param {number} offset
