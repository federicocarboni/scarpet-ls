...
/**
 * @param {string} uri
 * @param {import('@federicocarboni/scarpet-parser').FunctionDeclaration} node
 * @param {import('@federicocarboni/scarpet-parser').Node} reference
 */
 ...
 * @param {import('@federicocarboni/scarpet-parser').Node} node
